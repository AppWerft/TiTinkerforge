...
// in simulator we redefine to format for Tinkerforge Developer console
...
{\
	NSString * exceptionName = [@"org.tinkerforge." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tinkerforge";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITinkerforgeNativeItemNone = -1, 
	UITinkerforgeNativeItemSpinner = -2,
	UITinkerforgeNativeItemProgressBar = -3,
	
	UITinkerforgeNativeItemSlider = -4,
	UITinkerforgeNativeItemSwitch = -5,
	UITinkerforgeNativeItemMultiButton = -6,
	UITinkerforgeNativeItemSegmented = -7,
	
	UITinkerforgeNativeItemTextView = -8,
	UITinkerforgeNativeItemTextField = -9,
	UITinkerforgeNativeItemSearchBar = -10,
	
	UITinkerforgeNativeItemPicker = -11,
	UITinkerforgeNativeItemDatePicker = -12,
	
	UITinkerforgeNativeItemInfoLight = -13,
	UITinkerforgeNativeItemInfoDark = -14,
	
	UITinkerforgeNativeItemDisclosure = -15,
	
	UITinkerforgeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Tinkerforge instances of
