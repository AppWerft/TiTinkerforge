...
/**
 The base class for all Tinkerforge modules
 */
...
/**
 Tinkerforge Platform calls this method on startup.
 */
-(void)startup;

/**
 Tinkerforge Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Tinkerforge Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Tinkerforge Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Tinkerforge Platform calls this method on resume.
 @param sender The sender of the event.
 */
