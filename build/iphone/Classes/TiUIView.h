...
/**
 Base class for all Tinkerforge views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Tinkerforge view hierarchy (such as wrapped iOS UIViews) was touched.
