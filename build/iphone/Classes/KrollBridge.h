...
@interface TinkerforgeObject : KrollCoverageObject {
#else
@interface TinkerforgeObject : KrollObject {
#endif
@private
...
extern NSString * Tinkerforge$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TinkerforgeObject *_tinkerforge;
    KrollObject* console;
	BOOL shutdown;
